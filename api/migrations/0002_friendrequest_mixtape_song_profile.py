    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorited_by', models.ManyToManyField(blank=True, related_name='favorite_mixtapes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Song',
            fields=[
                ...
                ('mixtapes', models.ManyToManyField(blank=True, related_name='mixtapes', to='api.mixtape')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
