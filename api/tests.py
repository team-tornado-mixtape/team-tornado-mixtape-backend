...
class SearchTests(APITestCase):
    ...
    def test_search_artist2(self):
        ...
        self.assertEqual(response.data[6]["title"], "")
        self.assertEqual(response.data[7]["title"], "")
        self.assertEqual(response.data[8]["title"], "")
        self.assertEqual(response.data[9]["title"], "")
        self.assertEqual(response.data[10]["title"], "")
        self.assertEqual(response.data[11]["title"], "")
        self.assertEqual(response.data[12]["title"], "")
